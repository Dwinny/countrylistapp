              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ListItems(
                        country: 'Population:',
                        value: widget.lists.population.toString()),
                    ListItems(
                        country: 'Official Language:',
                        value: widget.lists.languages.toString()),
                    ...
                    ListItems(
                        country: 'Offcial Language:',
                        value: widget.lists.languages.toString()),
                    ListItems(
                        country: 'Capital:',
                        value: widget.lists.capital.toString()),
                    ListItems(
                        country: 'Region:',
                        value: widget.lists.region.toString()),
